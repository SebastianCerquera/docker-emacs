...
(defun work-agenda ()
  (interactive)
  (setq org-agenda-tag-filter-preset '("-periodic"))
  (find-file "/small/SMALL/WORK/PROJECT.org")
...
(defun personal-agenda ()
  (interactive)
  (setq org-agenda-tag-filter-preset '("-periodic"))
  (find-file "/small/SMALL/THINGS/PROJECT.org")
  (find-file "/small/SMALL/SKILLS/PROJECT.org")
  (find-file "/small/SMALL/THINGS/MAINTAINANCE/INVENTORY.org")
  (find-file "/small/SMALL/THINGS/MAINTAINANCE/chores/PROJECT.org")
  (let ((org-agenda-files '("/small/SMALL/THINGS/PROJECT.org" "/small/SMALL/SKILLS/PROJECT.org" "/small/SMALL/THINGS/MAINTAINANCE/chores/PROJECT.org")))
    (org-agenda)))
                                                                                                                                                                                                            
(defun unal-agenda ()
  (interactive)
  (find-file "~/REPO/UNAL/PROJECT.org")
  (find-file "~/REPO/UNAL/2015-02/PROJECT.org")
  (let ((org-agenda-files '("~/REPO/UNAL/PROJECT.org" "~/REPO/UNAL/2015-02/PROJECT.org")))
    (org-agenda)))
...
(defun periodic-agenda ()
  ...
  (find-file "/small/SMALL/WORK/PROJECT.org")
  (find-file "/small/SMALL/THINGS/PROJECT.org")
  (let ((org-agenda-files '("/small/SMALL/WORK/PROJECT.org" "/small/SMALL/THINGS/PROJECT.org")))
    (org-agenda)))
